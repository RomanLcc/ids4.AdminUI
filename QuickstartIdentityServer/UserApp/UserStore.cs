...
namespace QuickstartIdentityServer.UserApp
{
    ...
    {
        private readonly List<UserAppDto> _users =new List<UserAppDto>();
        private readonly PermissionConext db;

        /// <summary>
        /// Initializes a new instance of the <see cref="UserStore"/> class.
        /// </summary>
        public UserStore(PermissionConext db)
        {
            this.db = db;
        }
        ...
        /// <returns></returns>
        public UserAppDto FindByExternalProvider(string provider, string userId)
        {
